...
const approvedCollectionPages: readonly string[] = [
  "cansole-table.html",
  "center-table.html",
  "dining-table.html",
  "grill&partation.html",
  "laser-cansole-table.html",
  "laser-center-table.html",
  "laser-dining-table.html",
  "laser-grill-partation.html",
  "laser-mirror.html",
  "laser-side-table.html",
  "laser-sofa-chairs.html",
  "laser-wall-art.html",
  "mirror.html",
  "pvd-cansole-table.html",
  "pvd-center-table.html",
  "pvd-dining-table.html",
  "pvd-grill-partation.html",
  "pvd-mirror.html",
  "pvd-side-table.html",
  "pvd-sofa-chairs.html",
  "pvd-wall-art.html",
  "ramdev-accessories.html",
  "ramdev-bars.html",
  "ramdev-chairs.html",
  "ramdev-decorative-items.html",
  "ramdev-doors.html",
  "ramdev-gates.html",
  "ramdev-grills.html",
  "ramdev-handles.html",
...
export const referenceProducts: Product[] = catalogue.map((collection) => {
  ...
  return {
    ...
    name,
    category,
    approved: approvedCollectionPages.includes(collection.page),
    featured: [
      "ramdev-railings.html",
      "ramdev-grills.html",
      "ramdev-doors.html",
